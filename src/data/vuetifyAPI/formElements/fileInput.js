export default {
  ...
  props: {
    ...
    "hide-input": {
      ...
      type: "boolean",
      default: "false",
      desc: "Display the icon only without the input (file names)"
    },
    hint: {
      propName: "hint",
      type: "string",
    ...
    "truncate-length": {
      propName: "truncate-length",
      type: "number | string",
      default: "22",
      desc: "The length of a filename before it is truncated with ellipsis"
    },
    type: {
      propName: "type",
      type: "string",
    ...
    value: {
      ...
      type: "any",
      default: "undefined",
      desc: "A single or array of File objects."
    }
  },
  events: {
    blur: {
